...
const CollectionFeatured = ({
  featured: { imgUrl, imgUrl2, imgUrl3, imgUrl4, title, profil, names, item },
}) => (
  <div className="app__collection-card">
    <div className="app__collection-card_top">
      <img src={imgUrl} alt="Main Collection" />
      <div className="app__collection-card_children">
        <img src={imgUrl2} alt="Img Collection 2" />
        <img src={imgUrl3} alt="Img Collection 3" />
        <img src={imgUrl4} alt="Img Collection 4" />
      </div>
    </div>
    <div className="app__collection-card_bottom">
      <a href="#" className="h2__font1">
        {title}
      </a>
      ...
      <div className="app__collection-items">
        <div className="app__collection-items_content">
          {data.featureds.map((featured) => (
            <CollectionFeatured featured={featured} key={featured.title} />
          ))}
        </div>
      </div>
    </div>
